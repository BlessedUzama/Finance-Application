      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 border-b border-slate-800/80 pb-4">
        <div>
          <div className="flex items-center gap-2">
            <h3 className="text-base font-semibold text-white">Subscriptions & Recurring Overhead</h3>
        ...
        <div className="flex items-center gap-3">
          <div className="text-xs font-mono bg-slate-950 px-3 py-1.5 rounded-lg border border-slate-800">
            ...
            <span className="font-bold text-purple-400">{formatCurrency(monthlyOverhead)}</span>
            <span className="text-slate-500 text-[10px]"> ({formatCurrency(yearlyOverhead)}/yr)</span>
          </div>
          <button
        ...
        {subscriptions.map((sub) => (
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                <h4 className="text-xs font-semibold text-white truncate max-w-[110px]">{sub.name}</h4>
                <span className="text-[10px] text-slate-400 block font-mono">Due: {sub.dueDate}</span>
              </div>
            </div>
