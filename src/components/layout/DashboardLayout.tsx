        ...
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-3 sm:px-6 lg:px-8 gap-2">
          ...
          <div className="flex items-center gap-2 sm:gap-3 shrink-0">
            ...
            <div>
              ...
              <span className="ml-1.5 rounded-full bg-blue-500/10 px-2 py-0.5 text-[10px] font-semibold text-blue-600 dark:text-blue-400 border border-blue-500/20">
                PRO
              </span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-1.5 sm:gap-3 flex-wrap justify-end">
            ...
            <div className="flex items-center gap-1.5 rounded-lg bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 px-2.5 py-1 text-xs font-medium text-slate-800 dark:text-slate-300">
